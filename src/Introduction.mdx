...
1. **Feed the plan to your AI agent** — share the [execution-plan.md](https://github.com/mieweb/ui/tree/main/lessons/execution-plan.md) with your coding assistant
...
<div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '12px', marginTop: '16px', marginBottom: '24px' }}>
  ...
  <div style={{ padding: '16px', borderRadius: '8px', border: '1px solid var(--mieweb-border, #e5e7eb)' }}>
    <strong>Steps 6–9 — Clean Up & Verify</strong>
    <span style={{ margin: '8px 0 0', fontSize: '14px', color: 'var(--mieweb-muted-foreground, #737373)', display: 'block' }}>
      Remove unused dependencies, run an accessibility pass, verify light/dark/brand combinations, and document any remaining gaps.
    </span>
  </div>
</div>
...
| Guide | Purpose |
|-------|---------|
| [adopting-mieweb-ui.md](https://github.com/mieweb/ui/tree/main/lessons/adopting-mieweb-ui.md) | Audit methodology and component mapping |
| [tailwind4-integration.md](https://github.com/mieweb/ui/tree/main/lessons/tailwind4-integration.md) | Full CSS variable tables and PostCSS setup |
| [component-policy.md](https://github.com/mieweb/ui/tree/main/lessons/component-policy.md) | When to use, build locally, or contribute upstream |
| [compliance-prompt.md](https://github.com/mieweb/ui/tree/main/lessons/compliance-prompt.md) | Copy-paste AI prompt for a single-session migration |
