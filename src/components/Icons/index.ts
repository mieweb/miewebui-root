 ...
 * @mieweb/ui Icons
 *
 * Re-exports commonly used icons from lucide-react for convenience.
 * Consumers can also import directly from lucide-react for the full icon set.
 *
 * @example
 * ```tsx
 ...
 *
 * // Or import directly from lucide-react for full access
...
export {
  ...
  CircleUserRound as PatientIcon,
  ...
  Wheat as AllergyIcon,
  WheatOff as AllergyOffIcon,
...
// Also export the Icon component for dynamic usage
